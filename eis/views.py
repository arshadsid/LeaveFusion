...
def rspc_profile(request):
    ...
    return render(request, 'eis/eisModule/rspc_profile.html', context)
...
def generate_report(request):
    ...
    return render_to_pdf('eis/eisModule/generatereportshow.html', context)
...
def rspc_generate_report(request):
    ...
    return render_to_pdf('eis/eisModule/rspc_generatereportshow.html', context)